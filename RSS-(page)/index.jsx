    ...
    <div className="RSS">
      <div className="div-3">
        ...
        <div className="overlap-10">
          <div className="text-wrapper-15">Add an RSS URL</div>
        ...
        <div className="frame-2">
          ...
          <div className="frame-3">
            <p className="text-wrapper-17">Enter an RSS Feed URL</p>
          </div>
          <div className="text-wrapper-18">RSS Feed URL</div>
          ...
          <div className="overlap-14">
            ...
            <div className="text-wrapper-22">ADD RSS</div>
          </div>
        </div>
      </div>
    </div>
