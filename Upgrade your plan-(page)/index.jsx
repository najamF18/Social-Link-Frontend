    ...
    <div className="upgrade-your-plan">
      <div className="div-3">
        ...
        <div className="overlap-10">
          <div className="text-wrapper-16">Upgrade Your Plan</div>
        ...
        <div className="overlap-11">
          ...
          <div className="img-wrapper">
            <img className="ri-skip-left-fill" alt="Ri skip left fill" src="ri-skip-left-fill-2.svg" />
          </div>
          ...
          <Component className="component-15" polygon="polygon-7-2.svg" property1="default" />
          <div className="logo">&nbsp;&nbsp;&nbsp;&nbsp; logo</div>
          <p className="s-link">
            <span className="text-wrapper-17">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <span className="text-wrapper-18">S-Link</span>
          </p>
        </div>
        <div className="frame-2">
          <div className="overlap-13">
            <img className="ri-radio-button-fill" alt="Ri radio button fill" src="ri-radio-button-fill.svg" />
            <img className="ri-radio-button-fill-2" alt="Ri radio button fill" src="ri-radio-button-fill-2.svg" />
            <p className="monthly-premium-plan">
              <span className="text-wrapper-19">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
              <span className="text-wrapper-20">
                Monthly Premium Plan for $99 USD Per month.
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Annual Premium Plan for $960 USD for year.
              </span>
            </p>
          </div>
          ...
          <div className="overlap-14">
            <div className="text-wrapper-22">Upgrade to Monthly</div>
            <img className="maki-arrow" alt="Maki arrow" src="maki-arrow.svg" />
          </div>
        </div>
        <div className="overlap-15">
          <div className="rectangle-6" />
          <p className="upgrade-to-the">&nbsp;&nbsp;Upgrade to the Premium Plan</p>
          <p className="upgrade-to-the-2">
            <span className="text-wrapper-23">
              Upgrade to the Premium Plan and access the <br />
              following features:
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp; <br />
            </span>
            <span className="text-wrapper-24">
              Unlimited API Calls
              <br />
              1,000 Real-Time and Scheduled Posts
              <br />
              Post Videos and Multiple Images
              <br />
              Analytics on Posts, Links, and Social Profiles
              <br /> Supports Facebook, Facebook Groups, Twitter,&nbsp;&nbsp;&nbsp;&nbsp;Instagram, LinkedIn, Telegram,
              Reddit, Google Business Profile, Pinterest, TikTok, and YouTube
              <br />
              <br />
              Facebook, Instagram, LinkedIn, or X/Twitter @&nbsp;&nbsp;&nbsp;&nbsp;Mentions
              <br />
              Plus RSS feeds, Auto hashtags, and Scheduling
              <br />
          ...
          <img className="polygon-2" alt="Polygon" src="polygon-25.svg" />
          <img className="polygon-3" alt="Polygon" src="polygon-26.svg" />
          <img className="polygon-4" alt="Polygon" src="polygon-27.svg" />
          <img className="polygon-5" alt="Polygon" src="polygon-28.svg" />
          <img className="polygon-6" alt="Polygon" src="polygon-29.svg" />
          <img className="polygon-7" alt="Polygon" src="polygon-30.svg" />
          <img className="polygon-8" alt="Polygon" src="polygon-33.svg" />
          <img className="polygon-9" alt="Polygon" src="polygon-31.svg" />
          <img className="polygon-10" alt="Polygon" src="polygon-32.svg" />
