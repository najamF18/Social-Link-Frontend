    ...
    <div className="substack">
      <div className="div-3">
        ...
        <div className="overlap-10">
          <div className="text-wrapper-15">Substack URL</div>
        ...
        <div className="overlap-12">
          ...
          <div className="frame-2">
            ...
            <div className="frame-3">
              <div className="text-wrapper-17">Enter a Subtask URL</div>
            </div>
            <div className="text-wrapper-18">Substack URL</div>
            <div className="rectangle-3" />
            <div className="rectangle-4" />
            <div className="overlap-13">
              <div className="text-wrapper-19"># Automatically add hashtags</div>
              <div className="text-wrapper-20">Use first image</div>
            </div>
            <p className="text-wrapper-21">*Premium or Business Plan Required</p>
            <div className="overlap-14">
              <img className="group-2" alt="Group" src="group.png" />
              <div className="text-wrapper-22">Add Substack</div>
            </div>
          </div>
        </div>
