    ...
    <div className="account-screen">
      <div className="account-2">
        ...
        <div className="overlap-10">
          <div className="text-wrapper-15">Account</div>
        ...
        <div className="overlap-12">
          ...
          <div className="frame-2">
            <p className="n-a-company-name">
              ...
              <span className="text-wrapper-18">Company Name</span>
            </p>
            <div className="basic-plan-current">
              Basic Plan
              <br />
              Current Subscription
            </div>
            <div className="overlap-13">
              <div className="text-wrapper-19">Upgrade Your Plan</div>
        ...
        <div className="frame-3">
          <div className="text-wrapper-20">Delete Account</div>
          <div className="overlap-16">
            <div className="text-wrapper-21">Delete</div>
            <img className="mdi-delete" alt="Mdi delete" src="mdi-delete.svg" />
          </div>
        </div>
      </div>
    </div>
